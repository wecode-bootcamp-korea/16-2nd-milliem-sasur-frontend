...
export const MOBILE_SIGN_UP_API = `${SERVER_API}/users/mobile_signup`;
export const MOBILE_SIGN_IN_API = `${SERVER_API}/users/mobile_signin`;
export const KAKAO_API = `${SERVER_API}/users/kakao`;
export const KAKAO_KEY = "7453f93d6300d5120afb0460f1cf5f48";
